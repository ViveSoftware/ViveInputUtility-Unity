...
//
// public class VIUHandRenderer : MonoBehaviour, IViveRoleComponent
// {
//     [SerializeField]
...
//     bool renderAxis;
//     [SerializeField]
//     public bool renderTrackedBone = true;
//     bool oldRenderAxis;
//
...
//
//                     Vector3 lastPosition = curJoint.position;
//                     Quaternion lastRotation = curJoint.rotation;
//
//                     if (positionFix)
//                     {
//                         // if (a == 0)
...
//                     {
//                         bool stabilizePosition = false;
//                         if (stabilizePosition)
//                         {
//                             bool lockPosition = false;
//                             if (speedLimit > 0.0f)
//                             {
//                                 float diff = Vector3.Distance(lastPosition, curJoint.position);
//                                 if (diff < speedLimit)
//                                 {
//                                     curJoint.position = lastPosition;
//                                     lockPosition = true;
//                                 }
//                                 else
//                                 {
...
//                             }
//
//                             if (!lockPosition && speedCoef > 0.0f)
//                             {
//                                 //curJoint.position = Vector3.Lerp(lastPosition, curJoint.position, Mathf.Min(speedCoef * Time.deltaTime, 1.0f));
//                                 curJoint.position = Vector3.SmoothDamp(lastPosition, curJoint.position, ref velocity, speedCoef);
//                                 Debug.Log($"velocity = {velocity.ToString("0.000")}");
//                             }
//                         }
//                         else
//                         {
//                             if (algoL)
//                             {
//                                 float angle = Quaternion.Angle(lastRotation, curJoint.rotation);
//                                 if (angleThreshold > 0.0f)
//                                 {
//                                     if (angle < angleThreshold)
//                                     {
//                                         if (speedCoef > 0.0f)
//                                         {
//                                             curJoint.rotation = Quaternion.Slerp(lastRotation, curJoint.rotation, Mathf.Min(speedCoef * Time.deltaTime, 1.0f));
//                                         }
//                                     }
//                                     else
//                                     {
//                                         curJoint.rotation = Quaternion.RotateTowards(curJoint.rotation, lastRotation, angleThreshold);
//                                     }
//                                 }
//                             }
//                             else
//                             {
//                                 float angle = Quaternion.Angle(lastRotation, curJoint.rotation);
//                                 float angleSpeed = angle / Time.deltaTime;
//                                 if (angleThreshold > 0.0f && angle < angleThreshold)
//                                 {
//                                     curJoint.rotation = lastRotation;
//                                 }
//                                 else if (speedLimit > 0.0f && angleSpeed > speedLimit)
//                                 {
//                                     curJoint.rotation = Quaternion.Slerp(lastRotation, curJoint.rotation, speedLimit / angleSpeed);
//                                 }
//
//                                 if (speedCoef > 0.0f)
//                                 {
