...
//                        go.transform.SetParent(hook.transform, false);
//                        int count = 21;
//                        List<JointPose> list = new List<JointPose>();
...
//                            //
//                            //
//                            //Debug.Log(i + " " + JointPose.NameToIndex(list.ElementAt(i).name) + " " + list.ElementAt(i).pose.pos);
...
//                        //{
//                        //    Debug.Log(joint.name + " " + JointPose.NameToIndex(joint.name));
//                        //}
...
//                else
        ...
        private List<JointPose> m_handJointPose = new List<JointPose>();
...
//        }
        ...
        private static void SetWrist(IVRModuleDeviceStateRW state, HandJointName joint, RigidTransform pose)
        {
            ...
            state.handJoints[joint] = new JointPose(pos, rot);
            state.position = pos;
            state.rotation = rot;
        }
                        ...
                        case VRModuleDeviceModel.WaveTrackedHandLeft:
                            {
                                ...
                                state.handJoints[joint] = new JointPose(currPos, rot);
                            }
                            break;
